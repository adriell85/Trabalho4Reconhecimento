...
def gerar_dataset():
    ...
    # Classe 0 à esquerda na parte superior
    x1_classe_0 = np.random.uniform(0, 5, num_amostras_classe_0)
    x2_classe_0 = np.random.uniform(8, 10, num_amostras_classe_0)
    labels_classe_0 = np.zeros(num_amostras_classe_0, dtype=int)

    # Classe 1 à direita na parte superior
    x1_classe_1 = np.random.uniform(15, 20, num_amostras_classe_1)
    x2_classe_1 = np.random.uniform(8, 10, num_amostras_classe_1)
    labels_classe_1 = np.ones(num_amostras_classe_1, dtype=int)

    # Classe 2 no meio e mais embaixo
    x1_classe_2 = np.random.uniform(7.5, 12.5, num_amostras_classe_2)
    x2_classe_2 = np.random.uniform(3, 5, num_amostras_classe_2)
...
# Gerando o novo dataset ajustado
dataset_ajustado = gerar_dataset()
print(dataset_ajustado)